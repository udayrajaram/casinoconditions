...
const CASINOS = [
  ...
  { name: 'Foxwoods Resort Casino', location: 'Mashantucket, CT', state: 'CT', slug: 'foxwoods', lat: 41.4898, lon: -71.9590 },
  { name: 'Empire City Casino', location: 'Yonkers, NY', state: 'NY', slug: 'empire-city', lat: 40.9312, lon: -73.8988 },
  { name: 'Resorts World NYC', location: 'Queens, NY', state: 'NY', slug: 'resorts-world-nyc', lat: 40.6697, lon: -73.8330 },
  { name: 'Plainridge Park Casino', location: 'Plainville, MA', state: 'MA', slug: 'plainridge-park', lat: 42.0154, lon: -71.3284 },
  { name: 'Resorts World Catskills', location: 'Monticello, NY', state: 'NY', slug: 'resorts-world-catskills', lat: 41.6537, lon: -74.6910 },
  { name: 'MGM Springfield', location: 'Springfield, MA', state: 'MA', slug: 'mgm-springfield', lat: 42.1015, lon: -72.5898 },
  { name: 'Encore Boston Harbor', location: 'Everett, MA', state: 'MA', slug: 'encore-boston-harbor', lat: 42.3957, lon: -71.0820 },
  ...
  { name: 'Parx Casino', location: 'Bensalem, PA', state: 'PA', slug: 'parx-casino', lat: 40.1012, lon: -74.9480 },
  { name: 'Live! Casino Philadelphia', location: 'Philadelphia, PA', state: 'PA', slug: 'live-casino-philly', lat: 39.9100, lon: -75.1675 },
  ...
  { name: 'The Venetian Las Vegas', location: 'Las Vegas, NV', state: 'NV', slug: 'venetian-las-vegas', lat: 36.1210, lon: -115.1697 },
  ...
  { name: 'Greektown Casino-Hotel', location: 'Detroit, MI', state: 'MI', slug: 'greektown-casino', lat: 42.3326, lon: -83.0420 },
  { name: 'Rivers Casino Des Plaines', location: 'Des Plaines, IL', state: 'IL', slug: 'rivers-casino-des-plaines', lat: 41.9075, lon: -87.882 },
  { name: 'Hollywood Casino Aurora', location: 'Aurora, IL', state: 'IL', slug: 'hollywood-casino-aurora', lat: 41.7619, lon: -88.3159 },
  { name: 'Horseshoe Hammond', location: 'Hammond, IN', state: 'IN', slug: 'horseshoe-hammond', lat: 41.631, lon: -87.5007 },
  ...
  { name: 'IP Casino Resort Spa', location: 'Biloxi, MS', state: 'MS', slug: 'ip-casino-biloxi', lat: 30.3914, lon: -88.8800 },
  { name: 'Golden Nugget Biloxi', location: 'Biloxi, MS', state: 'MS', slug: 'golden-nugget-biloxi', lat: 30.4010, lon: -88.8723 },
  { name: 'Hollywood Casino Tunica', location: 'Tunica, MS', state: 'MS', slug: 'hollywood-casino-tunica', lat: 34.6418, lon: -90.3829 },
  { name: 'Coushatta Casino Resort', location: 'Kinder, LA', state: 'LA', slug: 'coushatta-casino-resort', lat: 30.4843, lon: -92.8508 },
  { name: 'Boomtown Casino New Orleans', location: 'Harvey, LA', state: 'LA', slug: 'boomtown-new-orleans', lat: 29.8894, lon: -90.0978 },
  ...
  { name: 'Seminole Casino Coconut Creek', location: 'Coconut Creek, FL', state: 'FL', slug: 'seminole-coconut-creek', lat: 26.2687, lon: -80.1786 },
  ...
  { name: 'Magic City Casino', location: 'Miami, FL', state: 'FL', slug: 'magic-city-casino', lat: 25.7742, lon: -80.2284 },
  { name: 'Isle Casino Racing Pompano Park', location: 'Pompano Beach, FL', state: 'FL', slug: 'isle-casino-pompano', lat: 26.2379, lon: -80.1243 },
  ...
  { name: 'Talking Stick Resort', location: 'Scottsdale, AZ', state: 'AZ', slug: 'talking-stick-resort', lat: 33.5726, lon: -111.8910 },
  ...
  { name: 'Morongo Casino Resort & Spa', location: 'Cabazon, CA', state: 'CA', slug: 'morongo-casino', lat: 33.9290, lon: -116.9712 },
  ...
  { name: 'Ilani Casino Resort', location: 'Ridgefield, WA', state: 'WA', slug: 'ilani-casino', lat: 45.8249, lon: -122.7412 },
  { name: 'Spirit Mountain Casino', location: 'Grand Ronde, OR', state: 'OR', slug: 'spirit-mountain-casino', lat: 45.0637, lon: -123.5720 },
  { name: 'Potawatomi Hotel & Casino', location: 'Milwaukee, WI', state: 'WI', slug: 'potawatomi-casino-milwaukee', lat: 43.0389, lon: -87.9384 },
  { name: 'Mystic Lake Casino Hotel', location: 'Prior Lake, MN', state: 'MN', slug: 'mystic-lake-casino', lat: 44.7455, lon: -93.4685 },
  ...
  { name: 'Prairie Band Casino & Resort', location: 'Mayetta, KS', state: 'KS', slug: 'prairie-band-casino', lat: 39.4194, lon: -95.7030 },
  { name: 'MGM National Harbor', location: 'Oxon Hill, MD', state: 'MD', slug: 'mgm-national-harbor', lat: 38.7843, lon: -77.0124 },
  { name: 'Live! Casino & Hotel Maryland', location: 'Hanover, MD', state: 'MD', slug: 'live-casino-maryland', lat: 39.1657, lon: -76.7282 },
  { name: 'Hollywood Casino Perryville', location: 'Perryville, MD', state: 'MD', slug: 'hollywood-casino-perryville', lat: 39.5612, lon: -76.0682 },
  ...
  { name: 'Spirit Mountain Casino', location: 'Grand Ronde, OR', state: 'OR', slug: 'spirit-mountain-casino-oregon', lat: 45.0637, lon: -123.5720 },
  { name: 'Ilani Casino Resort', location: 'Ridgefield, WA', state: 'WA', slug: 'ilani-casino-resort', lat: 45.8249, lon: -122.7412 },
  ...
  { name: 'Seminole Casino Coconut Creek', location: 'Coconut Creek, FL', state: 'FL', slug: 'seminole-casino-coconut-creek', lat: 26.2687, lon: -80.1786 },
  { name: 'Miccosukee Resort Gaming', location: 'Miami, FL', state: 'FL', slug: 'miccosukee-resort-gaming', lat: 25.7591, lon: -80.5932 },
  { name: 'Seminole Casino Brighton', location: 'Okeechobee, FL', state: 'FL', slug: 'seminole-casino-brighton', lat: 27.1832, lon: -81.0698 },
  { name: 'Seminole Casino Hotel Immokalee', location: 'Immokalee, FL', state: 'FL', slug: 'seminole-casino-immokalee', lat: 26.4274, lon: -81.414 },
  { name: 'Grand Casino Hinckley', location: 'Hinckley, MN', state: 'MN', slug: 'grand-casino-hinckley', lat: 46.0116, lon: -92.8927 },
  { name: 'Grand Casino Mille Lacs', location: 'Onamia, MN', state: 'MN', slug: 'grand-casino-mille-lacs', lat: 46.0827, lon: -93.6555 },
  { name: 'Treasure Island Resort Casino', location: 'Red Wing, MN', state: 'MN', slug: 'treasure-island-resort-mn', lat: 44.5875, lon: -92.7218 },
  { name: 'Black Bear Casino Resort', location: 'Carlton, MN', state: 'MN', slug: 'black-bear-casino', lat: 46.6527, lon: -92.4707 },
  { name: 'Shooting Star Casino Hotel', location: 'Mahnomen, MN', state: 'MN', slug: 'shooting-star-casino', lat: 47.3147, lon: -95.9608 },
  { name: 'Jackpot Junction Casino Hotel', location: 'Morton, MN', state: 'MN', slug: 'jackpot-junction-casino', lat: 44.3525, lon: -94.9851 },
  { name: 'Potawatomi Hotel Casino', location: 'Milwaukee, WI', state: 'WI', slug: 'potawatomi-hotel-casino', lat: 43.0254, lon: -87.9368 },
  { name: 'Ho-Chunk Gaming Wisconsin Dells', location: 'Baraboo, WI', state: 'WI', slug: 'ho-chunk-gaming-wisconsin-dells', lat: 43.49, lon: -89.806 },
  { name: 'Oneida Casino', location: 'Green Bay, WI', state: 'WI', slug: 'oneida-casino', lat: 44.5328, lon: -88.0596 },
  { name: 'Menominee Casino Resort', location: 'Keshena, WI', state: 'WI', slug: 'menominee-casino-resort', lat: 44.8833, lon: -88.6358 },
  { name: 'Lake of the Torches Resort Casino', location: 'Lac du Flambeau, WI', state: 'WI', slug: 'lake-of-the-torches-casino', lat: 45.9522, lon: -89.8697 },
  { name: 'Ho-Chunk Gaming Madison', location: 'Madison, WI', state: 'WI', slug: 'ho-chunk-gaming-madison', lat: 43.1566, lon: -89.2763 },
  { name: 'Northwoods Casino', location: 'Carter, WI', state: 'WI', slug: 'northwoods-casino', lat: 45.5494, lon: -88.9009 },
  { name: 'Golden Nugget Lake Charles', location: 'Lake Charles, LA', state: 'LA', slug: 'golden-nugget-lake-charles', lat: 30.2098, lon: -93.2071 },
  { name: 'Horseshoe Bossier City', location: 'Bossier City, LA', state: 'LA', slug: 'horseshoe-bossier-city', lat: 32.5243, lon: -93.735 },
  { name: 'Margaritaville Resort Casino Bossier City', location: 'Bossier City, LA', state: 'LA', slug: 'margaritaville-bossier-city', lat: 32.5274, lon: -93.7451 },
  { name: 'Boomtown Casino New Orleans', location: 'Harvey, LA', state: 'LA', slug: 'boomtown-casino-new-orleans', lat: 29.8894, lon: -90.0978 },
  { name: 'Harrahs Gulf Coast', location: 'Biloxi, MS', state: 'MS', slug: 'harrahs-gulf-coast', lat: 30.3928, lon: -88.8856 },
  { name: 'Gold Strike Casino Resort Tunica', location: 'Tunica, MS', state: 'MS', slug: 'gold-strike-tunica', lat: 34.6385, lon: -90.3762 },
  { name: 'Ameristar Casino Resort St Charles', location: 'St Charles, MO', state: 'MO', slug: 'ameristar-casino-st-charles', lat: 38.8041, lon: -90.5423 },
  { name: 'Harrahs North Kansas City', location: 'North Kansas City, MO', state: 'MO', slug: 'harrahs-north-kansas-city', lat: 39.1418, lon: -94.5751 },
  { name: 'Argosy Casino Hotel Spa', location: 'Riverside, MO', state: 'MO', slug: 'argosy-casino-riverside', lat: 39.1693, lon: -94.6228 },
  { name: 'Lumiere Place Casino', location: 'St Louis, MO', state: 'MO', slug: 'lumiere-place-casino', lat: 38.6298, lon: -90.1987 },
  { name: 'Isle of Capri Casino Hotel Boonville', location: 'Boonville, MO', state: 'MO', slug: 'isle-of-capri-boonville', lat: 38.9776, lon: -92.738 },
  { name: 'Horseshoe Casino Baltimore', location: 'Baltimore, MD', state: 'MD', slug: 'horseshoe-casino-baltimore', lat: 39.2756, lon: -76.6355 },
  { name: 'Rocky Gap Casino Resort', location: 'Flintstone, MD', state: 'MD', slug: 'rocky-gap-casino-resort', lat: 39.6965, lon: -78.6548 },
  { name: 'Dover Downs Hotel Casino', location: 'Dover, DE', state: 'DE', slug: 'dover-downs-casino', lat: 39.1582, lon: -75.5244 },
  { name: 'Delaware Park Casino', location: 'Wilmington, DE', state: 'DE', slug: 'delaware-park-casino', lat: 39.6527, lon: -75.5965 },
  { name: 'Harrington Raceway Casino', location: 'Harrington, DE', state: 'DE', slug: 'harrington-raceway-casino', lat: 38.9237, lon: -75.5774 },
  { name: 'Kickapoo Lucky Eagle Casino Hotel', location: 'Eagle Pass, TX', state: 'TX', slug: 'kickapoo-lucky-eagle-casino', lat: 28.7132, lon: -100.4954 },
  { name: 'Naskila Gaming', location: 'Livingston, TX', state: 'TX', slug: 'naskila-gaming', lat: 30.8388, lon: -94.938 },
  { name: 'Speaking Rock Entertainment Center', location: 'El Paso, TX', state: 'TX', slug: 'speaking-rock-el-paso', lat: 31.652, lon: -106.2871 },
  { name: 'Ysleta del Sur Pueblo Casino', location: 'El Paso, TX', state: 'TX', slug: 'ysleta-del-sur-casino', lat: 31.6501, lon: -106.2856 },
  { name: 'Running Aces Casino Hotel', location: 'Columbus, MN', state: 'MN', slug: 'running-aces-casino', lat: 45.2847, lon: -93.1533 },
  { name: 'Fond-du-Luth Casino', location: 'Duluth, MN', state: 'MN', slug: 'fond-du-luth-casino', lat: 46.7867, lon: -92.1005 },
  { name: 'Palace Casino Resort', location: 'Cass Lake, MN', state: 'MN', slug: 'palace-casino-resort-mn', lat: 47.3797, lon: -94.6044 },
  { name: 'Rivers Casino Des Plaines', location: 'Des Plaines, IL', state: 'IL', slug: 'rivers-casino-des-plaines-il', lat: 41.9075, lon: -87.882 },
  { name: 'Par-A-Dice Hotel Casino', location: 'East Peoria, IL', state: 'IL', slug: 'par-a-dice-casino', lat: 40.6947, lon: -89.5409 },
  { name: 'Casino Queen', location: 'East St Louis, IL', state: 'IL', slug: 'casino-queen-east-st-louis', lat: 38.6318, lon: -90.1491 },
  { name: 'Hollywood Casino Joliet', location: 'Joliet, IL', state: 'IL', slug: 'hollywood-casino-joliet', lat: 41.525, lon: -88.0817 },
  { name: 'Horseshoe Hammond', location: 'Hammond, IN', state: 'IN', slug: 'horseshoe-hammond-in', lat: 41.631, lon: -87.5007 },
  { name: 'Blue Chip Casino Hotel Spa', location: 'Michigan City, IN', state: 'IN', slug: 'blue-chip-casino-michigan-city', lat: 41.7108, lon: -86.895 },
  { name: 'Four Winds South Bend', location: 'South Bend, IN', state: 'IN', slug: 'four-winds-south-bend-in', lat: 41.6764, lon: -86.252 },
  { name: 'Belterra Casino Resort', location: 'Florence, IN', state: 'IN', slug: 'belterra-casino-resort', lat: 38.8124, lon: -84.9563 },
  { name: 'Mohegan Sun Casino', location: 'Uncasville, CT', state: 'CT', slug: 'mohegan-sun-casino', lat: 41.4901, lon: -72.0957 },
  { name: 'Foxwoods Resort Casino Main', location: 'Mashantucket, CT', state: 'CT', slug: 'foxwoods-resort-casino', lat: 41.4898, lon: -71.959 },
  { name: 'Boot Hill Casino Resort', location: 'Dodge City, KS', state: 'KS', slug: 'boot-hill-casino', lat: 37.7528, lon: -100.0171 },
  { name: 'Kansas Star Casino', location: 'Mulvane, KS', state: 'KS', slug: 'kansas-star-casino', lat: 37.4756, lon: -97.2176 },
  { name: 'Hollywood Casino at Kansas Speedway', location: 'Kansas City, KS', state: 'KS', slug: 'hollywood-casino-kansas-speedway', lat: 39.1147, lon: -94.831 },
  { name: 'Hard Rock Hotel Casino Sioux City', location: 'Sioux City, NE', state: 'NE', slug: 'hard-rock-sioux-city', lat: 42.4974, lon: -96.3956 },
  { name: 'WarHorse Casino Grand Island', location: 'Grand Island, NE', state: 'NE', slug: 'warhorse-casino-grand-island', lat: 40.925, lon: -98.342 },
  { name: 'Chinook Winds Casino Resort', location: 'Lincoln City, OR', state: 'OR', slug: 'chinook-winds-casino', lat: 44.976, lon: -124.0171 },
  { name: 'Seven Feathers Casino Resort', location: 'Canyonville, OR', state: 'OR', slug: 'seven-feathers-casino', lat: 42.9238, lon: -123.2735 },
  { name: 'Wildhorse Resort Casino', location: 'Pendleton, OR', state: 'OR', slug: 'wildhorse-resort-casino', lat: 45.5708, lon: -118.7827 },
  { name: 'Catawba Two Kings Casino', location: 'Kings Mountain, NC', state: 'NC', slug: 'catawba-two-kings-casino', lat: 35.249, lon: -81.3412 },
  { name: 'Harrahs Cherokee Valley River', location: 'Murphy, NC', state: 'NC', slug: 'harrahs-cherokee-valley-river-nc', lat: 35.0654, lon: -84.0196 },
  { name: 'Rivers Casino Portsmouth VA', location: 'Portsmouth, VA', state: 'VA', slug: 'rivers-casino-portsmouth-va', lat: 36.8354, lon: -76.3683 },
  { name: 'Hard Rock Hotel Casino Bristol VA', location: 'Bristol, VA', state: 'VA', slug: 'hard-rock-bristol-va', lat: 36.5951, lon: -82.1887 },
  { name: 'Hollywood Casino Hotel Raceway Bangor', location: 'Bangor, ME', state: 'ME', slug: 'hollywood-casino-bangor', lat: 44.8012, lon: -68.7789 },
  { name: 'Passamaquoddy Tribe Casino', location: 'Princeton, ME', state: 'ME', slug: 'passamaquoddy-tribe-casino', lat: 45.204, lon: -67.5623 },
  { name: 'Glacier Peaks Casino', location: 'Browning, MT', state: 'MT', slug: 'glacier-peaks-casino', lat: 48.556, lon: -113.0097 },
  { name: 'Little Big Horn Casino', location: 'Crow Agency, MT', state: 'MT', slug: 'little-big-horn-casino', lat: 45.568, lon: -107.4287 },
];
...
function buildPool(casino, weather = null) {
  ...
  const general = [
    // Vibes & observations
    { b: `floor is maybe ${pick([60,70,75,80])}% full right now, decent energy`, c: '📢 General', h: rand(3,11) },
    { b: 'good energy in here tonight, people seem to be winning', c: '📢 General', h: rand(2,8) },
    { b: 'been here since 7, still going strong 😅 not ready to leave', c: '📢 General', h: rand(1,6) },
    { b: 'service has been really solid all night, staff are on it', c: '📢 General', h: rand(2,9) },
    { b: 'not too crowded tonight, easy to get around and find machines', c: '📢 General', h: rand(1,7) },
    { b: 'super busy tonight but the energy is amazing, love it when its packed', c: '📢 General', h: rand(3,12) },
    { b: 'parking was smooth, maybe 3-4 min wait at the garage', c: '📢 General', h: rand(4,14) },
    { b: 'just cashed out up a few hundred, calling it a great night 💰', c: '📢 General', h: rand(5,18) },
    { b: `been here ${rand(2,5)} hours and still not ready to leave, place is addictive lol`, c: '📢 General', h: rand(2,7) },
    { b: 'brought my parents for their anniversary, they are absolutely loving it 🥰', c: '📢 General', h: rand(8,22) },
    { b: 'bachelorette party on the floor right now making it SO fun lol', c: '📢 General', h: rand(6,16) },
    { b: 'live entertainment tonight is actually really good, bonus', c: '📢 General', h: rand(3,10) },
    { b: 'loyalty card comped me dinner tonight, great value 🙌', c: '📢 General', h: rand(4,13) },
    { b: 'came for an hour, stayed for four. you know how it goes 😂', c: '📢 General', h: rand(7,19) },
    { b: `drinks at ${pick(v.bars)} are strong tonight, no complaints 🍹`, c: '📢 General', h: rand(3,11) },
    { b: `just ate at ${pick(v.restaurants)} — honestly really good, would recommend`, c: '📢 General', h: rand(4,13) },
    { b: `bartender at ${pick(v.bars)} is incredible, best service all night`, c: '📢 General', h: rand(5,15) },
    { b: `${pick(v.restaurants)} has a wait but it moves fast, worth it`, c: '📢 General', h: rand(3,9) },
    { b: `surprisingly not too crowded for a ${pick(['Friday','Saturday'])} night`, c: '📢 General', h: rand(5,16) },
    { b: 'valet took like 3 minutes, super smooth operation tonight', c: '📢 General', h: rand(4,12) },
    { b: 'floor is hopping right now, good turnout for a weeknight', c: '📢 General', h: rand(2,8) },
    { b: 'first time back in a while — forgot how fun this place is', c: '📢 General', h: rand(3,10) },
    { b: 'date night turned into a whole evening, no regrets 😂', c: '📢 General', h: rand(6,17) },
    { b: 'staff here are genuinely friendly, makes a huge difference', c: '📢 General', h: rand(4,13) },
    { b: 'place is packed but everyone seems to be in a good mood, great vibe', c: '📢 General', h: rand(3,11) },
    ...(isVegas ? [
      { b: `flew in just for the weekend — ${n} was 100% the right call`, c: '📢 General', h: rand(6,18) },
      { b: 'Vegas energy in here is insane tonight 🎰 nothing like it', c: '📢 General', h: rand(5,15) },
      { b: 'Strip is absolutely packed, had to walk through like 4 casinos to get here lol', c: '📢 General', h: rand(4,13) },
      { b: 'classic Vegas night, every single time this place delivers', c: '📢 General', h: rand(5,16) },
    ] : []),
    ...(isAC ? [
      { b: `drove down from Philly, totally worth it — ${n} is always the move`, c: '📢 General', h: rand(4,13) },
      { b: 'AC weekend trip hitting different tonight, good crowd', c: '📢 General', h: rand(3,10) },
    ] : []),
    ...(isCT ? [
      { b: `CT casino night — ${n} still the best in the state imo`, c: '📢 General', h: rand(4,12) },
      { b: 'made the drive out here and it was definitely worth it tonight', c: '📢 General', h: rand(3,9) },
    ] : []),
    ...(isMidwest ? [
      { b: 'great night out, this is always a solid spot', c: '📢 General', h: rand(2,8) },
    ] : []),
    ...(isSouth ? [
      { b: 'Southern hospitality on full display here tonight 🙌', c: '📢 General', h: rand(3,11) },
    ] : []),
  ];

  const slots = [
    { b: 'slots have been SO kind to me tonight, up like $400 🎰', c: '🎰 Slots', h: rand(5,17) },
    { b: 'machines feeling loose tonight honestly, hitting more than usual', c: '🎰 Slots', h: rand(4,13) },
    { b: `hit a $${pick([350,500,750,1100,1500,2200])} jackpot on a bonus round 🎉🎉`, c: '🎰 Slots', h: rand(12,35) },
    { b: `found a hot machine on ${pick(v.slots)}, been sitting here for an hour 🔥`, c: '🎰 Slots', h: rand(4,14) },
    { b: `${pick(v.slots)} is absolutely popping tonight, people cheering over there`, c: '🎰 Slots', h: rand(3,11) },
    { b: 'high limit room is buzzing, saw two big wins in the last 20 min 👀', c: '🎰 Slots', h: rand(5,16) },
    { b: 'Buffalo Gold is everywhere on this floor tonight, seems popular', c: '🎰 Slots', h: rand(3,10) },
    { b: 'Dragon Link is packed on both ends, hot machine tonight', c: '🎰 Slots', h: rand(4,12) },
    { b: 'Lightning Link been hitting for a few people near me 👀', c: '🎰 Slots', h: rand(3,11) },
    { b: `my friend just hit a nice bonus on ${pick(v.slots)}, she is screaming lol 🎉`, c: '🎰 Slots', h: rand(8,22) },
    { b: `had a great run on ${pick(v.slots)}, cashing out before it turns around 😂`, c: '🎰 Slots', h: rand(5,14) },
    { b: 'down a little on slots but honestly had a great time, worth it', c: '🎰 Slots', h: rand(2,7) },
    { b: `${pick(v.slots)} machine has NOT been hitting for me tonight 😩 moving on`, c: '🎰 Slots', h: rand(4,12) },
    { b: 'high limit room feels different energy tonight, more wins happening', c: '🎰 Slots', h: rand(3,10) },
    { b: 'up a little on slots, know when to walk — calling it a win 🙌', c: '🎰 Slots', h: rand(4,13) },
  ];

  const tables = [
    { b: 'blackjack tables have been so good to me tonight, dealer busting constantly 🃏', c: '🎲 Table Games', h: rand(5,16) },
    { b: 'craps table is LOUD right now lol, huge run happening 🎲', c: '🎲 Table Games', h: rand(8,24) },
    { b: `found a $${pick([10,15])} blackjack table, staying here all night 👍`, c: '🎲 Table Games', h: rand(6,18) },
    { b: 'dealer has been ice cold tonight, our whole table is up 😂', c: '🎲 Table Games', h: rand(7,20) },
    { b: 'good run at blackjack, up about $300 so far 🙌', c: '🎲 Table Games', h: rand(5,15) },
    { b: 'three blackjacks in the last hour, running absolutely HOT 🔥', c: '🎲 Table Games', h: rand(9,25) },
    { b: 'craps table went on a 25 min run, place went absolutely crazy 🎲', c: '🎲 Table Games', h: rand(11,30) },
    { b: 'found a 3:2 BJ table with a $10 min, this is the spot tonight', c: '🎲 Table Games', h: rand(8,22) },
    { b: '6:5 blackjack tables are brutal — hunting for a 3:2 game rn', c: '🎲 Table Games', h: rand(6,17) },
    { b: 'roulette hitting on my numbers back to back, cant explain it 🤑', c: '🎲 Table Games', h: rand(7,19) },
    { b: 'tables are packed but moving fast, good dealers tonight', c: '🎲 Table Games', h: rand(3,10) },
    { b: 'table minimums are really reasonable tonight, $10-15 on most', c: '🎲 Table Games', h: rand(5,14) },
    { b: 'great run on craps, shooter held the dice for like 20 minutes 🙌', c: '🎲 Table Games', h: rand(10,28) },
    { b: 'three card poker is a total trap but I keep playing it and winning lol', c: '🎲 Table Games', h: rand(6,16) },
    { b: 'baccarat crowd is super lively right now, good energy over there', c: '🎲 Table Games', h: rand(4,12) },
    { b: 'Spanish 21 table is open right now if anyone wants it, good game', c: '🎲 Table Games', h: rand(5,14) },
  ];

  const poker = [
    { b: '1/2 NL is super soft tonight, lots of recreational players in town 🐟', c: '🃏 Poker Room', h: rand(6,18) },
    { b: 'wait for 1/2 is short right now, maybe 10-15 min fyi', c: '🃏 Poker Room', h: rand(5,16) },
    { b: 'just doubled up at 1/2, incredible table, everyone is gambling 🃏', c: '🃏 Poker Room', h: rand(8,22) },
    { b: `2/5 game running, ${rand(2,4)} tables going right now, good action`, c: '🃏 Poker Room', h: rand(5,14) },
    { b: `bad beat jackpot is at $${rand(55,95)}k — everyone is playing scared poker lol`, c: '🃏 Poker Room', h: rand(7,20) },
    { b: 'been grinding 1/2 for 3 hours, up almost 2 buy-ins 🙌 great table', c: '🃏 Poker Room', h: rand(8,21) },
    { b: `tournament has ${rand(60,140)} runners tonight, solid field`, c: '🃏 Poker Room', h: rand(4,13) },
    { b: 'tournament just started, crowd is super fired up 🔥', c: '🃏 Poker Room', h: rand(5,15) },
    { b: '5/10 is running if anyone wants higher stakes action tonight', c: '🃏 Poker Room', h: rand(4,12) },
    { b: 'late night poker is always the best here — looser play, more fun', c: '🃏 Poker Room', h: rand(6,17) },
    { b: 'poker room has great energy tonight, good mix of regulars and tourists', c: '🃏 Poker Room', h: rand(4,13) },
    { b: `just won a $${rand(400,900)} pot with quads 😱 best hand of the year`, c: '🃏 Poker Room', h: rand(14,38) },
    { b: `sat down with $${pick([200,300])}, already up to $${pick([550,700,900])} 🎉`, c: '🃏 Poker Room', h: rand(9,24) },
    { b: `waiting for 1/2, list is ${rand(3,8)} deep — worth the wait from what I can see`, c: '🃏 Poker Room', h: rand(3,10) },
    { b: '1/2 game has some serious fish tonight 🐟 easiest table in months', c: '🃏 Poker Room', h: rand(7,19) },
  ];

  const asks = [
    { b: `is the 1/2 NL running right now at ${n}? worth heading over?`, c: '🃏 Poker Room', t: 'ask', h: 0 },
    { b: `what are the blackjack minimums ${tn}? any $10 tables open?`, c: '🎲 Table Games', t: 'ask', h: 0 },
    { b: `how crowded is ${n} right now? thinking about driving over`, c: '📢 General', t: 'ask', h: 0 },
    { b: `anyone at ${n} right now? how is the floor looking ${tn}?`, c: '📢 General', t: 'ask', h: 0 },
    { b: `are the slots hitting at all ${tn} or is it a dead night?`, c: '🎰 Slots', t: 'ask', h: 0 },
    { b: 'craps table still running? what is the min tonight?', c: '🎲 Table Games', t: 'ask', h: 0 },
    { b: `is ${pick(v.restaurants)} packed ${tn}? trying to decide if I need a reservation`, c: '📢 General', t: 'ask', h: 0 },
    { b: `worth making the drive out ${tn}? on the fence about it`, c: '📢 General', t: 'ask', h: 0 },
    { b: `how is parking ${tn}? any issues getting in?`, c: '📢 General', t: 'ask', h: 0 },
    { b: `is the high limit room busy ${tn}? any machines open?`, c: '🎰 Slots', t: 'ask', h: 0 },
  ];

  const answers = [
    { b: `just walked through — poker room has ${rand(3,7)} tables of 1/2 running, list is short`, c: '🃏 Poker Room', h: rand(4,13) },
    { b: 'yeah definitely worth it tonight, floor is active and people are winning', c: '📢 General', h: rand(5,15) },
    { b: `floor is maybe ${pick([65,70,75,80])}% full right now, easy to find machines`, c: '📢 General', h: rand(4,13) },
    { b: `parking was totally fine when I got here around ${pick(['7pm','8pm','9pm'])}, no issues`, c: '📢 General', h: rand(5,14) },
    { b: `BJ tables are $${pick([10,15,25])} min on the main floor right now`, c: '🎲 Table Games', h: rand(6,16) },
    { b: 'yeah slots are decent tonight, hit two bonuses in the last hour already', c: '🎰 Slots', h: rand(5,14) },
    { b: 'floor is really active tonight, good call to come out', c: '📢 General', h: rand(4,12) },
    { b: 'parking garage has plenty of spots right now fyi, come on over', c: '📢 General', h: rand(3,10) },
    { b: `I am here now — ${n} is great tonight, definitely make the drive`, c: '📢 General', h: rand(6,17) },
    { b: 'high limit room has some open machines, not too packed right now', c: '🎰 Slots', h: rand(4,12) },
  ];
...
async function seedCasino(casino, force = false) {
  ...
  const rows = toPost.map((p, i) => {
    ...
    // Spread posts across last 6 hours with newer posts more recent
    const maxMinutesAgo = 360;
    const minutesAgo = rand(i * 5 + 2, maxMinutesAgo - i * 20);
    return {
      casino:        casino.name,
      body:          p.b,
      category:      p.c,
